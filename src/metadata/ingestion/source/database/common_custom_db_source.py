...
class CommonCustomDbSourceService(
    ...
    def __init__(
        ...
        # 2024.03.22(금) custom. 사용자정의DB Source.get_connection() 호출 하도록 수정
        self.engine: Engine = self.get_connection(self.service_connection)
