...
# class SnowflakeSource(LifeCycleQueryMixin, StoredProcedureMixin, CommonDbSourceService, MultiDBSource):
class SnowflakeSource(CommonDbSourceService, MultiDBSource):
    """
