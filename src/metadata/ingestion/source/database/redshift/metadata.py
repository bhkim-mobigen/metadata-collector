...
# class RedshiftSource(LifeCycleQueryMixin, StoredProcedureMixin, CommonDbSourceService, MultiDBSource):
class RedshiftSource(CommonDbSourceService, MultiDBSource):
    """
