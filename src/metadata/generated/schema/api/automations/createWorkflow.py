...
#   filename:  createWorkflow.json
#   timestamp: 2024-07-31T00:32:08+00:00
...
class TestServiceConnection(BaseModel):
    class Config:
        extra = Extra.forbid
...
class CreateWorkflowRequest(BaseModel):
    ...
    name: EntityName = Field(..., description='Name of the workflow.')
    displayName: Optional[str] = Field(
    ...
    request: TestServiceConnection = Field(
