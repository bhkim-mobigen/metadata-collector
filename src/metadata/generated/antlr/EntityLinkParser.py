# Generated from /Users/hayoung/workspace/openmetadata-generator/openmetadata-spec/src/main/antlr4/org/openmetadata/schema/EntityLink.g4 by ANTLR 4.9.2
# encoding: utf-8
from antlr4 import *
...
class EntityLinkParser ( Parser ):
    ...
    class EntitylinkContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitEntitylink" ):
                return visitor.visitEntitylink(self)
            else:
    ...
    class EntityAttributeContext(EntityContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitEntityAttribute" ):
                return visitor.visitEntityAttribute(self)
            else:
                return visitor.visitChildren(self)
    ...
    class EntityTypeContext(EntityContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitEntityType" ):
                return visitor.visitEntityType(self)
            else:
                return visitor.visitChildren(self)
    ...
    class EntityFieldContext(EntityContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitEntityField" ):
                return visitor.visitEntityField(self)
            else:
                return visitor.visitChildren(self)
    ...
    class EntityFqnContext(EntityContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitEntityFqn" ):
                return visitor.visitEntityFqn(self)
            else:
                return visitor.visitChildren(self)
